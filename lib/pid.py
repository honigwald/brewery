## The recipe gives simple implementation of a 
## Discrete Proportional-Integral-Derivative (PID) controller. 
## PID controller gives output value for error between desired reference 
...
class PID:
    ...
    def __init__(   self, P=2.0, I=0.0, D=1.0, Derivator=0,
